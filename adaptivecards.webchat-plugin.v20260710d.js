...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.scout-ac-shell .ac-pushButton, .scout-ac-shell .ac-actionSet button, .scout-ac-shell button.ac-pushButton { display: inline-flex !important; align-items: center !important; justify-content: center !important; width: 100% !important; min-height: 36px !important; max-height: 36px !important; padding: 6px 14px !important; border-radius: ' + T.radiusLg + ' !important; font-family: Montserrat, sans-serif !important; font-size: 13px !important; font-weight: 600 !important; cursor: pointer !important; transition: all 150ms cubic-bezier(0.4,0,0.2,1) !important; outline: none !important; box-sizing: border-box !important; pointer-events: auto !important; -webkit-appearance: none !important; appearance: none !important; }',
      ...
      '.scout-ac-shell .ac-actionSet { gap: 5px !important; padding: 0 10px 10px !important; margin: 0 !important; }',
      ...
      /* Logo sits on white chip so green brand art stays visible on green header */
      '.scout-ac-shell .ac-image { border-radius: 6px !important; background: #FFFFFF !important; padding: 3px !important; box-sizing: content-box !important; object-fit: contain !important; }',
      '.scout-ac-shell .ac-image img, .scout-ac-shell img.ac-image, .scout-ac-shell img { background: #FFFFFF !important; border-radius: 6px !important; padding: 3px !important; box-sizing: content-box !important; object-fit: contain !important; max-height: 28px !important; max-width: 28px !important; }',
